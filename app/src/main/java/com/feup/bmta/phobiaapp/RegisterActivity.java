    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // Obtem a data de nascimento do DatePicker
                int day = datePicker.getDayOfMonth();
                int month = datePicker.getMonth();
                int year = datePicker.getYear();
                String dateOfBirth = day + "/" + (month + 1) + "/" + year;

                // Obtem o género selecionado
                int selectedGenderId = genderRadioGroup.getCheckedRadioButtonId();
                RadioButton selectedGenderRadioButton = findViewById(selectedGenderId);

                // Chaa o método addUser para inserir o utilizador na base de dados
                ...
                if (isValidRegistration(fullName, dateOfBirth, selectedGenderRadioButton, idCardNumber, username, password)) {
                    ...
                    // Passa os dados do utilizador para a nova atividade
                    ...
                    finish(); // Finaliza a atividade após o registo bem-sucedido
                }
            }
        });
    }
