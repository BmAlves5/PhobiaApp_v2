...
public class BluetoothService extends Activity
{
    ...
    private DBHelper dbHelper; // Declare this variable in your BluetoothService class

// In your onCreate() method or wherever appropriate, initialize the DBHelper
            ...
            switch (msg.what)
            {
                ...
                case BioLib.MESSAGE_ECG_STREAM:
                    try
                    {
                        ...
                        // Store ECG data in SQLite database
                        dbHelper.addECGData(ecgDataString);
